...
import { Users, Building2, Activity, Bell, FileCheck } from "lucide-react";
      ...
      <div className="grid gap-6 grid-cols-1 lg:grid-cols-7">
        ...
        <Card className="lg:col-span-3 p-6">
          <h3 className="text-lg font-bold mb-4">Yaklaşan Randevular</h3>
           <div className="h-[200px] flex flex-col items-center justify-center border-2 border-dashed border-gray-200 rounded-lg bg-gray-50 text-gray-400 text-center p-4">
             <Activity className="w-8 h-8 mb-2 opacity-50" />
             <p className="text-sm font-medium">Henüz randevu sistemi aktif değil</p>
             <p className="text-xs mt-1">Gelecek güncellemelerle burada randevularınızı görebileceksiniz.</p>
           </div>
        </Card>
      </div>
    </div>
